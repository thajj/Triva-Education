...
//  Category(13, "Musicals & Theatres", icon: LineAwesomeIcons.theaterMasks),
  ...
  Category(16, "Board Games", icon: LineAwesomeIcons.puzzle_piece),
  ...
  Category(20, "Mythology", icon: LineAwesomeIcons.angellist),
  Category(21, "Sports", icon: LineAwesomeIcons.soccer_ball_o),
  Category(22, "Geography", icon: LineAwesomeIcons.map),
  Category(23, "History", icon: LineAwesomeIcons.history),
  Category(24, "Politics", icon: LineAwesomeIcons.institution),
//  Category(25, "Art", icon: LineAwesomeIcons.paintBrush),
  ...
  Category(29, "Comics", icon: LineAwesomeIcons.book),
//  Category(30, "Science Gadgets", icon: LineAwesomeIcons.mobileAlt),
  Category(31, "Japanese Anime & Manga"),
  Category(32, "Cartoon & Animation", icon: LineAwesomeIcons.tv),
];
