...
final List<Event> events = [
  Event('cat_numbers.png', 'Les nombres', 'questions complétées'),
  Event('cat_shapes.png', 'Les formes', 'questions complétées'),
  Event('cat_colors.png', 'Les couleurs', 'questions complétées'),
  Event('level_1.jpg', 'Autres', 'questions complétées'),
  Event('level_2.jpg', 'Autres', 'questions complétées'),
  Event('level_3.jpg', 'Autres', 'questions complétées'),
